...
public class WeatherServiceManager{
    ...
    public static void main(String[] args){
        ...
        System.out.printf("Please enter two cities. \n");
        ...
        {
            System.out.printf(City1.m_oWeather.name + " has the greatest temperature. \n");
        }
        else
        {
            System.out.printf(City2.m_oWeather.name + " has the greatest temperature. \n");
        }
        //range calculation
        float City1Range = City1.m_oWeather.main.temp_max - City1.m_oWeather.main.temp_min;
        float City2Range = City2.m_oWeather.main.temp_max - City2.m_oWeather.main.temp_min;

        //comparison
        if(City1Range > City2Range)
        {
            System.out.printf(City1.m_oWeather.name + "  has the greatest range" );
        }
        else
        {
            System.out.printf(City2.m_oWeather.name + " has the greatest range" );
        }
		// ###### END: YOUR CODE HERE ######
    }
